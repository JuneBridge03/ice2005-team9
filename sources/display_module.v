module display_module #(
    ...
    display_FSM_module #(.fsm_cnt_max(FSM_MAX)) display_fsm(.sa_2x2_11(sa_2x2_11), .sa_2x2_12(sa_2x2_12), .sa_2x2_21(sa_2x2_21), .sa_2x2_22(sa_2x2_22), .sa_3x3_11(sa_3x3_11), .sa_3x3_12(sa_3x3_12), .sa_3x3_21(sa_3x3_21), .sa_3x3_22(sa_3x3_22), .clk(clk), .rst(rst), .display_data(display_data), .state(state));
