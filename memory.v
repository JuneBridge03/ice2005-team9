...
module memory (
    ...
    // Matrix A Inputs (4x4)
    input [7:0] A11, A12, A13, A14, A21, A22, A23, A24, A31, A32, A33, A34, A41, A42, A43, A44,
    ...
    output reg [7:0] nextstate123
);

    // =========================================================================
    // 내부 연결용 Wire 선언 (각 하위 모듈들을 연결할 선)
    // =========================================================================
    ...
    // =========================================================================
    // 1. 내부 모듈 조립 (Instantiations)
    // =========================================================================
    Register_Bank u_Reg (
        .clk(clk), .rst(rst), .write_en(write),
    ...
    // =========================================================================
    // 2. 출력 선택기 (MUX) - sel_mode에 맞춰 밖으로 내보낼 선을 결정
    // =========================================================================
    always @(*) begin
        ...
        case (sel_mode)
            2'b00: begin A1_out = pe_A1; F1_out = pe_F1; rst_PE = pe_rst; nextstate123 = pe_state; end
            2'b01: begin A1_out = sys3_A1; A2_out = sys3_A2; A3_out = sys3_A3; rst_SYS_3x3 = sys3_rst; nextstate123 = sys3_state; end
            2'b10: begin A1_out = sys2_A1; A2_out = sys2_A2; F1_out = sys2_F1; F2_out = sys2_F2; rst_SYS_2x2 = sys2_rst; nextstate123 = sys2_state; end
        endcase
    end
endmodule
